...
I denne del af opgaven vil jeg gennemgå metoden der vil blive brugt til at undersøge mit hovedspørgsmål. Her vil jeg komme ind på min analysestrategi i form af den statistiske modellering og dernæst vil jeg forholde mig til faldgruber omkring fixed effects modeller. Herefter vil jeg beskrive indsamlingen og opbygningen af mit originale datasæt, hvor jeg også vil beskrive de variable der vil blive brugt i analysen. Slutteligt vil jeg forholde mig til fordelingen af vindmøller på tværs af valgår og geografi samt studiets overordnede generaliseringspotentiale.

## Model

I dette afsnit vil jeg gennemgå de modeller jeg har opstillet for at undersøge mit spørgsmål gennem det naturlige eksperiment. Jeg kommer ind på overvejelser omkring min analyse, herunder modellering og valg af kontrolvariable.
...
Jeg har valgt at gå med en tovejs fixed effects model for at imødekomme det udeladt variabel bias [@stock2020: 367], der helt uundgåeligt vil forekomme med det datasæt jeg har produceret. Mine modeller estimeres ved hjælp af `feols` fra @berge2024.
...
En grafisk inspektion af antagelsen om parallele trends kan ses i @fig-prl-trends nedenfor. Jeg vurderer antagelsen om parallele trends til at være tilpas overholdt, da der for gruppen der modtager en vindmølle i perioden mellem 2013 og 2017 har helt parallel linje med de aldrig-treatede. Dog er der små problemer med trenden for dem der modtager vindmølle i 2017, hvilket skyldes, at borgmesterpartierne generelt modtager en større andel af stemmerne ved valget i 2017. I @fig-appendiks-prl-trends i Appendiks B (side \pageref{fig-appendiks-prl-trends}) har jeg illustreret udviklingen for alle treatmentgrupper med en loess kurve i stedet for de rette linjer. Der kan det tydeligt ses, at der er en pludselig stigning i det generelle niveau, hvilket jeg vurderer til at være årsagen til det lille brud på antagelsen om parallele trends i @fig-prl-trends. Med denne generelle stigning vurderer jeg ikke antagelsen om parallele trends mellem de *aldrig-treatede* og treatmentgrupperne som brudt.
...
I denne ogpave har jeg valgt at benytte vindmøllens tilslutningsdato som indikator for vindmøllens *tilstedeværelse* i lokalområdet. Det har jeg primært gjort af hensyn til tilgængelighed af data og opgavens omfang. @energistyrelsen2024 har meget gode optegnelser over, hvornår vindmøllerne er tilsluttet elnettet og disse data er også relativt let tilgængelige. For i stedet at fokusere på den beslutning hvor konstruktionen af en vindmølle tillades ville det kræve deltajerede optegnelser over alle behandlinger af lokalplansændringer i den periode jeg undersøger, hvilket bestemt kan indsamles, men det kræver mange flere timer, end hvad der har været til rådighed for dette projekt.

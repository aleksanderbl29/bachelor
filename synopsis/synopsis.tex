...
Jeg kan godt lide de grafiske muligheder vi finder hos
@bischofNewGraphicSchemes2017 - og dem vil jeg benytte så vidt muligt.
...
\section{Forventninger}\label{forventninger}

\newpage{}

\section{Bibliografi}\label{bibliografi}
